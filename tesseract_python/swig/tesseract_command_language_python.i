...
%clear Eigen::VectorX<double>&;
%apply const Eigen::VectorX<double>& { Eigen::VectorX<double>& };
...
%include "rework_include/tesseract_command_language/state_waypoint.i"
...
// %template(ProfileDictionary_hasProfileEntry_##TYPE) tesseract_common::ProfileDictionary_hasProfileEntry<tesseract_planning::TYPE>;
// %template(ProfileDictionary_removeProfileEntry_##TYPE) tesseract_common::ProfileDictionary_removeProfileEntry<tesseract_planning::TYPE>;
// %template(ProfileDictionary_getProfileEntry_##TYPE) tesseract_common::ProfileDictionary_getProfileEntry<tesseract_planning::TYPE>;
// %template(ProfileDictionary_addProfile_##TYPE) tesseract_common::ProfileDictionary_addProfile<tesseract_planning::TYPE>;
// %template(ProfileDictionary_getProfile_##TYPE) tesseract_common::ProfileDictionary_getProfile<tesseract_planning::TYPE>;
// %template(ProfileDictionary_hasProfile_##TYPE) tesseract_common::ProfileDictionary_hasProfile<tesseract_planning::TYPE>;
// %template(ProfileDictionary_removeProfile_##TYPE) tesseract_common::ProfileDictionary_removeProfile<tesseract_planning::TYPE>;
%enddef

%define %tesseract_command_language_add_profile_type2(NAME, TYPE )
// %template(ProfileDictionary_hasProfileEntry_##NAME) tesseract_common::ProfileDictionary_hasProfileEntry<tesseract_planning::TYPE>;
// %template(ProfileDictionary_removeProfileEntry_##NAME) tesseract_common::ProfileDictionary_removeProfileEntry<tesseract_planning::TYPE>;
// %template(ProfileDictionary_getProfileEntry_##NAME) tesseract_common::ProfileDictionary_getProfileEntry<tesseract_planning::TYPE>;
// %template(ProfileDictionary_addProfile_##NAME) tesseract_common::ProfileDictionary_addProfile<tesseract_planning::TYPE>;
// %template(ProfileDictionary_getProfile_##NAME) tesseract_common::ProfileDictionary_getProfile<tesseract_planning::TYPE>;
// %template(ProfileDictionary_hasProfile_##NAME) tesseract_common::ProfileDictionary_hasProfile<tesseract_planning::TYPE>;
// %template(ProfileDictionary_removeProfile_##NAME) tesseract_common::ProfileDictionary_removeProfile<tesseract_planning::TYPE>;
%enddef
